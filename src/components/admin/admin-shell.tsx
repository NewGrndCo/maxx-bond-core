...
export function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0d] text-neutral-100 flex">
      <aside className="w-64 shrink-0 border-r border-white/5 bg-black/40 backdrop-blur-xl flex flex-col">
        ...
        <div className="p-3 border-t border-white/5 space-y-2">
          <Link
            to="/"
            className="block text-xs text-neutral-500 hover:text-neutral-300 px-3"
          >
            ← View public site
          </Link>
